	...
	return(
		<div class="instructions container-fluid layer1">
			...
			<div class="row infoRow layer2">
				...
				<hr />
					<ul>
						<li class="A infoContainer"><h3><span>A</span>Legendary</h3><div class="Areduced subInfo"><p>Legendary Items are worth the most of any items. Find one of these and you are rich! Sought after by the gods due to their unique power to change color.</p></div></li>
						<li class="B infoContainer shadow"><h3><span>B</span>Epic</h3><div class="Breduced subInfo"><p>Feel free to sell these at all points in the game. These are the second best item you can get. Typically purchased by government agencies for research.</p></div></li>
						<li class="C infoContainer shadow"><h3><span>C</span>Rare</h3><div class="Creduced subInfo"><p>Find a Rare and prepare to find yourself with a decent amount of cash. Feel free to sell this item at any point.</p></div></li>
						<li class="D infoContainer shadow"><h3><span>D</span>Common</h3><div class="Dreduced subInfo"><p>A cheap item for the common buyer. You might be breaking even selling these. Sometimes worth less than Trash, because at least you can recycle Trash for keys.</p></div></li>
						<li class="F infoContainer"><h3><span>F</span>Trash</h3><div class="Freduced subInfo"><p>Worth nothing. Recycle trash into a new key with the Recycler Upgrade or Hydraulic Press Upgrade. Get these upgrades first, then sell your Trash items to recycle them. </p></div></li>
					</ul>	
				</section>
